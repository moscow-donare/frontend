...
export default function SobreNosotrosPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="">
        {/* Header Section */}
        <div className="bg-gradient-to-br from-primary-600 to-secondary-800 py-12">
          <section className="mb-16 text-center">
            <h1 className="text-5xl font-bold mb-6 text-default-100">
              Sobre Nosotros
            </h1>
          ...
          <section className="mb-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              <Card className="text-center p-6 hover:shadow-lg transition-shadow bg-white/10 backdrop-blur-sm">
                <CardBody>
                  ...
                  <h3 className="text-lg text-white font-semibold mb-2">Nuestra Misión</h3>
              ...
              <Card className="text-center p-6 hover:shadow-lg transition-shadow bg-white/10 backdrop-blur-sm">
                <CardBody>
                  ...
                  <h3 className="text-lg font-semibold text-white mb-2">Nuestro Impacto</h3>
                  <p className="text-sm text-white">
            ...
            <p className="text-xl text-white mb-8 text-center mt-10">
        ...
        <Divider className="my-16" />
        <div className="bg-gradient-to-br from-primary-600 to-secondary-800 py-16">
          {/* Contact Section */}
          <ContactSection />
        </div>
      </div>
