...
export const StepTwo: React.FC = () => {
  ...
  const { handleNextStep, handlePrevStep } = useEditCampaigns();
  ...
  return (
    <div>
      <h2 className="text-xl font-semibold mb-6 text-gray-900">Editar Contenido de la Campaña</h2>
          ...
          {formData.image ? (
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-600">
                {formData.imageFile ? 'Nueva imagen cargada' : 'Imagen actual de la campaña'}
              </p>
              <Button
                type="button"
