...
import { Heart, Twitter, Facebook, Instagram, Github } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="mailto:info@donare.com" className="text-gray-400 hover:text-white transition-colors">info@donare.com</a></li>
              <li><a href="tel:+123456789" className="text-gray-400 hover:text-white transition-colors">+1 (234) 567-89</a></li>
              <li><span className="text-gray-400">Ciudad, País</span></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <p className="text-center text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} Donare. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
