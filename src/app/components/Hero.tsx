        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="order-2 md:order-1">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 leading-tight">
              Donaciones Transparentes con <span className="text-purple-300">Blockchain</span>
            </h1>
            <p className="text-lg md:text-xl mb-6 text-teal-100">
              Revoluciona la forma en que gestionas tus campañas solidarias con total transparencia, 
          ...
          <div className="order-1 md:order-2 flex justify-center">
            <div className="relative">
              <div className="w-64 h-64 md:w-80 md:h-80 bg-white rounded-lg shadow-lg overflow-hidden">
                <img 
